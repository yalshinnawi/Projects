...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            "*** YOUR CODE HERE ***"
            if isinstance(insect, QueenAnt) and insect.TrueQueen == 1:
                return
            # END Problem 13
...
class HarvesterAnt(Ant):
    ...
    def action(self, colony):
        ...
        # BEGIN Problem 1
        "*** YOUR CODE HERE ***"
        colony.food += self.food_production
        # END Problem 1
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        if self.contained_ant is None and not other.is_container:# we will modify
           return True
        else:
           return False
        # END Problem 9
...
# END Problem 13
    ...
    def __init__(self, armor=1):
        ...
        self.TrueQueen += 1
        QueenAnt.TrueQueen = self.TrueQueen
        # END Problem 13
    ...
    def action(self, colony):
        ...
        if self.TrueQueen > 1:
            ...
            while tile != None:
                #container and
                if tile.ant != None and tile.ant.is_container:
                    if tile.ant != None and not(tile.ant.buffed): #and tile.ant.contained_ant:
                        tile.ant.damage = 2 * tile.ant.damage
                        tile.ant.buffed = True
                    if tile.ant.contained_ant != None and not(tile.ant.contained_ant.buffed):
                        tile.ant.contained_ant.damage = 2 * tile.ant.contained_ant.damage
                        tile.ant.contained_ant.buffed = True
                elif tile.ant != None and not(tile.ant.buffed):
                    tile.ant.damage = 2 * tile.ant.damage
                    tile.ant.buffed = True
                tile = tile.exit
        # END Problem 13
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor <= 0 and self.TrueQueen == 1:
            bees_win()
        # END Problem 13
