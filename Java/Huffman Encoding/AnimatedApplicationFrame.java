...
public class AnimatedApplicationFrame extends JFrame
{
    ...
    private JLabel speedFeedbackLabel;
    ...
    *  @param width desired width of the drawing window
    *  @param height desired height of the drawing window.
    *  @param title the title of the window
    *  @param controlledThread the thread that the animation window controls
    ...
    */
    private void createControls()
    {
        ...
        speedFeedbackLabel = new JLabel("");
        speedLabel = new JLabel("Speed");
        speedLabel.setHorizontalAlignment(SwingConstants.RIGHT);
        speedTextField = new JTextField( (new Integer(INITIAL_DELAY)).toString() );
        ...
        // add components to the speed panel
        speedPanel.setLayout(new GridLayout(1,2,5,1));
        ...
        controlPanel.add(speedFeedbackLabel);
 ...
 /** Set up listeners for each of the controller components.
    ...
    */
    ...
    /** Handler for the speed text field enter.
    */
    private void speedTextFieldHandler()
    {
        try
        {
            String input = speedTextField.getText().trim();
            ...
            if(newDelay < 10)
                speedFeedbackLabel.setText("Delay is " + delayInSeconds + " seconds: Warning not recommended");
            else
                speedFeedbackLabel.setText("Delay is " + delayInSeconds + " seconds");
            repaint();
        }
        catch(Exception e)
        {
    ...
    */
    ...
    // A private class for handling the destruction of windows
